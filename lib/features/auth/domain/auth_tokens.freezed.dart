...
mixin _$AuthTokens {
 ...
 String get accessToken; String get refreshToken; String get tokenType;@JsonKey(fromJson: _expiresInFromJson) String? get expiresIn;
...
@useResult
$Res call({
 String accessToken, String refreshToken, String tokenType,@JsonKey(fromJson: _expiresInFromJson) String? expiresIn
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType, @JsonKey(fromJson: _expiresInFromJson)  String? expiresIn)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthTokens() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType, @JsonKey(fromJson: _expiresInFromJson)  String? expiresIn)  $default,) {final _that = this;
switch (_that) {
case _AuthTokens():
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  String tokenType, @JsonKey(fromJson: _expiresInFromJson)  String? expiresIn)?  $default,) {final _that = this;
switch (_that) {
case _AuthTokens() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn);case _:
  return null;
...
class _AuthTokens implements AuthTokens {
  const _AuthTokens({required this.accessToken, required this.refreshToken, this.tokenType = 'Bearer', @JsonKey(fromJson: _expiresInFromJson) this.expiresIn});
...
@override@JsonKey(fromJson: _expiresInFromJson) final  String? expiresIn;
